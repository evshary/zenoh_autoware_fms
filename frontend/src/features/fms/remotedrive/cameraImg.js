export const CamImageWithStatus = (props) => {
    ...
    const currentGear = telemetry.current_gear || '';
        ...
        <div className={props.classname}>
            ...
            <div className="relative w-[40%] max-w-sm p-6 z-10 text-base-content">
                <div className="bg-base-100/70 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-5">
                    ...
                    {props.isControlling !== undefined && (
                        <div className={`mb-4 py-1.5 px-3 rounded-xl text-center font-black text-[10px] uppercase tracking-[0.2em] border shadow-sm transition-all duration-500 ${props.isControlling
                            ? 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20'
                            : 'bg-error/10 text-error border-error/20 animate-pulse'}`}>
                            {props.isControlling ? "Active Control" : "System Preempted"}
                        </div>
                    )}
                        ...
                        <tbody>
                            ...
                            <tr className="border-b border-base-content/10">
                                ...
                                <td colSpan="2" className="text-right">
                                    ...
                                    <span className={`font-mono text-lg font-bold tracking-tight ${telemetry.mode === 'CRUISE' ? 'text-sky-500 dark:text-sky-400' : 'text-amber-500 dark:text-amber-400'}`}>
                                        {telemetry.mode || '---'}
                                    </span>
                                </td>
                            </tr>
